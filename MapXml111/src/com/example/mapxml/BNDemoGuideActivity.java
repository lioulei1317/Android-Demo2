...
public class BNDemoGuideActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Home_Activity.activityList.add(this);
		createHandler();
		...
		if (intent != null) {
			...
			if (bundle != null) {
				mBNRoutePlanNode = (BNRoutePlanNode) bundle
						.getSerializable(Home_Activity.ROUTE_PLAN_NODE);
	...
	protected void onDestroy() {
		...
		// Home_Activity.activityList.remove(this);
		...
		if (mBNRoutePlanNode != null) {
			item1 = new CustomizedLayerItem(mBNRoutePlanNode.getLongitude(),
					...
					mBNRoutePlanNode.getCoordinateType(), getResources()
							.getDrawable(R.drawable.marker_wz_1),
