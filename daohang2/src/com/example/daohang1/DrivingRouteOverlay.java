...
/**
 * 用于显示�?条驾车路线的overlay，自3.4.0版本起可实例化多个添加在地图中显示，当数据中包含路况数据时，则默认使用路况纹理分段绘�?
 */
public class DrivingRouteOverlay extends OverlayManager {
	...
	public List<BitmapDescriptor> getCustomTextureList() {
		...
		list.add(BitmapDescriptorFactory
				.fromAsset("Icon_road_yellow_arrow.png"));
